...
async function cargarCards() {
    try {
        ...
        // Fallback: mostrar cards estáticos si el JSON falla
        displayStaticCards();
    }
}
...
function sortCards(orderType) {
    ...
    cards.sort((a, b) => {
        ...
        switch (orderType) {
            ...
            case 'date':
                // Aquí podrías agregar lógica para ordenar por fecha si agregas ese campo
                return 0;
            case 'popular':
